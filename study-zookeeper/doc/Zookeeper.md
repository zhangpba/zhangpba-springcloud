...
![02_无状态化的实现.png](02_无状态化的实现.png)

## 二、搭建ZooKeeper服务器

### 1、zoo.conf配置文件说明

![03_zoo.conf配置文件说明.png](03_zoo.conf配置文件说明.png)
![19_服务器截图.png](19_服务器截图.png)
...
![09_watch机制getDate.png](09_watch机制getDate.png)

- 当被Watch的Znode已删除，服务端会查找哈希表，找到该Znode对应的所有Watcher，异步通知客户端，并且删除哈希表中对应的key-value。

![10_watch机制zNode删除.png](10_watch机制zNode删除.png)
...
- 编写4个zoo.cfg
  ...
  个人服务
  server.1=9.134.236.215:2001:3001
  server.2=9.134.236.215:2002:3002
  server.1=9.134.236.215:2003:3003
  server.1=9.134.236.215:2004:3004:observer
  ...
  ./zkCli.sh -server 9.134.236.215:2181,9.134.236.215:2182,9.134.236.215:2183
  ~~~
...
![13_集群上线选举过程.png](13_集群上线选举过程.png)
...
![14_主从服务器之间的数据同步.png](14_主从服务器之间的数据同步.png)
